package com.kingpec.site.entity;
 ...
 */
@Entity
@Table(name = "kp_site_manage", schema = "")
@SuppressWarnings("serial")
public class KpSiteManageEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="MERC_NO",nullable=true,length=50)
	...
	@Column(name ="TERM_NO",nullable=true,length=50)
