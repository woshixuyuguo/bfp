package com.kingpec.site.service.impl;
...
@Service("kpSiteManageService")
@Transactional
public class KpSiteManageServiceImpl extends CommonServiceImpl implements KpSiteManageServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(KpSiteManageEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(KpSiteManageEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(KpSiteManageEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 	
	 	//-----------------java增强 start---------------------------
	}
 	
 	private Map<String,Object> populationMap(KpSiteManageEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,KpSiteManageEntity t){
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("kp_site_manage",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,KpSiteManageEntity t){
