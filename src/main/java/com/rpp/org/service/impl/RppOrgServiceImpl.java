package com.rpp.org.service.impl;
...
@Service("rppOrgService")
@Transactional
public class RppOrgServiceImpl extends CommonServiceImpl implements RppOrgServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(RppOrgEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(RppOrgEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(RppOrgEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 	
	 	//-----------------java增强 start---------------------------
	}
 	
 	private Map<String,Object> populationMap(RppOrgEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,RppOrgEntity t){
 		...
 		sql  = sql.replace("#{key}",String.valueOf(t.getKey()));
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("rpp_org",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,RppOrgEntity t){
