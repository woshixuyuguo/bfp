 ...
 */
@Entity
@Table(name = "rpp_org", schema = "")
@SuppressWarnings("serial")
public class RppOrgEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  机构商号
	 */

	@Column(name ="AGT_ID",nullable=true,length=50)
	...
	@Column(name ="MERC_ID",nullable=true,length=50)
	 ...
	 *@return: java.math.BigDecimal  通道费率
	 */
	 ...
	 *@param: java.math.BigDecimal  通道费率
	 */
