 ...
 */
@Entity
@Table(name = "rpp_agent_pssfil", schema = "")
@SuppressWarnings("serial")
public class RppAgentPssfilEntity implements java.io.Serializable {
	/**主键*/
	...
	/**状态*/
	@Excel(name="状态",width=15,dicCode="pssfilState")
	...
	@Column(name ="MONEY_ACT",nullable=true,length=32)
