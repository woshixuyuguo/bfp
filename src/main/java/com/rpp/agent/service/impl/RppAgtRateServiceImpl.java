...
@Service("rppAgtRateService")
@Transactional
public class RppAgtRateServiceImpl extends CommonServiceImpl implements RppAgtRateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(RppAgtRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(RppAgtRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(RppAgtRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 	
	 	//-----------------java增强 start---------------------------
	}
 	
 	private Map<String,Object> populationMap(RppAgtRateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,RppAgtRateEntity t){
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("rpp_agt_rate",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,RppAgtRateEntity t){
