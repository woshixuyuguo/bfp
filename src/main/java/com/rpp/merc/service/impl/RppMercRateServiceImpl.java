...
@Service("rppMercRateService")
@Transactional
public class RppMercRateServiceImpl extends CommonServiceImpl implements RppMercRateServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(RppMercRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(RppMercRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(RppMercRateEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 	
	 	//-----------------java增强 start---------------------------
	}
 	
 	private Map<String,Object> populationMap(RppMercRateEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,RppMercRateEntity t){
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("rpp_merc_rate",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,RppMercRateEntity t){
