...
@Service("rppMercPssfilService")
@Transactional
public class RppMercPssfilServiceImpl extends CommonServiceImpl implements RppMercPssfilServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(RppMercPssfilEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(RppMercPssfilEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(RppMercPssfilEntity t) throws Exception{
	 	//-----------------sql增强 end------------------------------
	 	
	 	//-----------------java增强 start---------------------------
	}
 	
 	private Map<String,Object> populationMap(RppMercPssfilEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,RppMercPssfilEntity t){
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("rpp_merc_pssfil",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,RppMercPssfilEntity t){
