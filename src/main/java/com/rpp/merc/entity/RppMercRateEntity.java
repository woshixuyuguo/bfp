 ...
 */
@Entity
@Table(name = "rpp_merc_rate", schema = "")
@SuppressWarnings("serial")
public class RppMercRateEntity implements java.io.Serializable {
	/**主键*/
