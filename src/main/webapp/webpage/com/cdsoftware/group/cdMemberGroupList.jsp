...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cdMemberGroupList" checkbox="true" fitColumns="false" title="转发记录" actionUrl="cdMemberGroupController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="会员"  field="memberId"  hidden="false"  queryMode="single" dictionary="cd_member,id,pet_name" width="120"></t:dgCol>
   <t:dgCol title="活动"  field="activityId"  hidden="false"  queryMode="single" dictionary="cd_activity,id,name" width="120"></t:dgCol>
   <t:dgCol title="群Id"  field="groupId"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
