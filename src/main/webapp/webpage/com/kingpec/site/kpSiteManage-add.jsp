...
<script src="plug-in/themes/bootstrap-ext/js/common.js"></script>
 ...
 <form id="formobj" action="kpSiteManageController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="siteName" name="siteName" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入站点名称"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="mercNo" name="mercNo" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入商户编号"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="termNo" name="termNo" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入终端编号"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="state" name="state" type="text" maxlength="2" class="form-control input-sm" placeholder="请输入状态"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
