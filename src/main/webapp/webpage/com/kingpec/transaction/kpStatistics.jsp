...
<link rel="stylesheet"
	href="plug-in/themes/naturebt/css/search-form.css">
<link rel="stylesheet"
	    	    ...
	    	    xAxis : [
	    	        {
	    	            ...
	    	            type : 'category',
	    	            data : ['合肥路店','山东路店','福州南路店','福州北路店','长沙路店','重庆南路店','黑龙江路店','辽宁路店','合肥路店','山东路店','福州南路店','福州北路店','长沙路店','重庆南路店','黑龙江路店','辽宁路店','合肥路店','山东路店','福州南路店','福州北路店','长沙路店','重庆南路店','黑龙江路店','辽宁路店','合肥路店','山东路店','福州南路店','福州北路店','长沙路店','重庆南路店','黑龙江路店','辽宁路店']
	    	        }
	    	    ],
	    	    yAxis : [
	    	        {
	    	    ...
	    	    series : [
	    	        {
	    	            ...
	    	            type:'bar',
	    	            barWidth : 25,//柱图宽度
	    	            data:[5.0, 4.9, 7.0, 15.2,10.0, 6.9, 9.0, 13.2,5.0, 4.9, 7.0, 15.2,10.0, 6.9, 9.0, 13.2,5.0, 4.9, 7.0, 15.2,10.0, 6.9, 9.0, 13.2,5.0, 4.9, 7.0, 15.2,10.0, 6.9, 9.0, 13.2],
	    				color:'#5aaafb'
