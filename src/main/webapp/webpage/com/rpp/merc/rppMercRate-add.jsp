...
<script src="plug-in/themes/bootstrap-ext/js/common.js"></script>
 ...
 <form id="formobj" action="rppMercRateController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="mercCode" name="mercCode" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入商户"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="rateCode" name="rateCode" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入费率通道"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="rate" name="rate" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入费率"  datatype="n" ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="state" name="state" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入状态"  datatype="*" ignore="ignore" />
			</div>
		</div>
	</div>
</form>
