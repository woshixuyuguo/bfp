...
<t:datagrid name="userList" title="商户管理" actionUrl="mercController.do?datagrid" fit="true" fitColumns="false" idField="id" queryMode="group" >
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="mercController.do?addorupdate" funname="add" height="420"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="mercController.do?addorupdate" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.password.reset" icon="icon-edit" url="mercController.do?changepasswordforuser" funname="update"></t:dgToolBar>
	<t:dgToolBar title="common.lock.user" icon="icon-edit" url="mercController.do?lock&lockvalue=0" funname="lockObj"></t:dgToolBar>
	<t:dgToolBar title="common.unlock.user" icon="icon-edit" url="mercController.do?lock&lockvalue=1" funname="unlockObj"></t:dgToolBar>
...
function deleteDialog(id){
	var url = "mercController.do?deleteDialog&id=" + id
...
<script type="text/javascript">
	//导入
	function ImportXls() {
		openuploadwin('Excel导入', 'mercController.do?upload', "userList");
	}

	//导出
	function ExportXls() {
		JeecgExcelExport("mercController.do?exportXls", "userList");
	}

	//模板下载
	function ExportXlsByT() {
		JeecgExcelExport("mercController.do?exportXlsByT", "userList");
	}
</script>