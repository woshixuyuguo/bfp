...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="agtController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
                <input class="inputxt" name="mercName" value="${user.agtName}"    />
                <span class="Validform_checktip"></span>
            </td>
		</tr>
		<tr>
