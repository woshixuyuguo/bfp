...
<script src="plug-in/themes/bootstrap-ext/js/common.js"></script>
 ...
 <form id="formobj" action="rppAgentTransactionController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="agtCode" name="agtCode" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入机构商户代码"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
 ...
 typeGroupCode="accountChangeType" 			 hasLabel="false"  title="变动类型"></t:dictSelect>     
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="beforeMoney" name="beforeMoney" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入变动前金额"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
 ...
 typeGroupCode="accountChangeSource" 			 hasLabel="false"  title="变动来源"></t:dictSelect>     
			</div>
		</div>
	</div>
</form>
