...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                                <span><img alt="image" width="180" height="61" src="plug-in/login/images/dms.png" /></span>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="navbar-header" style="height: 60px;"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                    <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                        <div class="form-group">
                            <input type="text" placeholder="欢迎使用智慧加油银行对账系统" class="form-control" name="top-search" id="top-search">
                        </div>
                    </form>
                </div>
        ...
        <div class="footer" style="border-top:none;">
            <div class="pull-right">&copy; <t:mutiLang langKey="system.version.number"/> <a href="http://www.jeecg.org/" target="_blank">RPP</a>
            </div>
        </div>        
    </div>
    <!--右侧部分结束-->
